...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScraperPageBase.parent'
        db.add_column('scraping_scraperpagebase', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scraping.ScraperPageBase'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScraperPageBase.parent'
        db.delete_column('scraping_scraperpagebase', 'parent_id')
